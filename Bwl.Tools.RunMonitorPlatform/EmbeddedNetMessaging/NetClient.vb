...
Public Class NetClient
    ...
    'Private waitingResult2 As Hierarchic
    ...
    ''' <remarks></remarks>
    Public Event SentMessage(ByVal message As NetMessage)
    ''' <summary>
    ...
    ''' <remarks></remarks>
    Public Function SendMessageWaitAnswer(ByVal message As NetMessage, ByVal answerFirstPart As String, Optional ByVal timeout As Single = 20.0) As NetMessage
        SyncLock waiterRoot
            Try
