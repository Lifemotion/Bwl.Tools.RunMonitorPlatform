...
Public Class NetServer
	...
	Public ReadOnly Property Clients() As List(Of ConnectedClient)
		Get
	...
	Private Sub ParseBytesInMessage(ByVal client As ClientData, ByVal broken As Boolean)
		...
		End If
	End Sub
	Public Event ClientConnected(ByVal client As ConnectedClient)
	Public Event ClientDisonnected(ByVal client As ConnectedClient)
	Public Event ReceivedMessage(ByVal message As NetMessage, ByVal client As ConnectedClient)
	' Public Event ReceivedHierarchicMessage(ByVal message As Hierarchic, ByVal client As ConnectedClient)
	Public Event SentMessage(ByVal message As NetMessage, ByVal client As ConnectedClient)
	...
	''' <remarks></remarks>
	Public Overloads Sub SendMessage(ByVal client As ConnectedClient, ByVal message As NetMessage)
		For Each connClient In connectedClients.ToArray
